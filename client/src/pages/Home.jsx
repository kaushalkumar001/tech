...
export const Home = () => {
  ...
  return (
    <div className="sabhain">
      ...
      <section>
        <div className="containerthree">
          <div className="box1">
            <div className="box1in">
              ...
              <p>Fast Wi-Fi, reliable connection, unlimited access, secure network, seamless streaming.</p>
            </div>
          </div>
          <div className="box2">
            <div className="box2in">
              <h2>Security and Surveillance</h2>
              <p>24/7 monitoring, CCTV cameras, secure access, emergency response, safe hostel environment.</p>
            </div>
          </div>
          <div className="box3">
            <div className="box3in">
              <h2>24 Hour Electricity Supply</h2>
              <p>Uninterrupted power, reliable supply, always on, no outages, constant electricity.</p>
            </div>
          </div>
        </div>
      </section>
       <div className="container grid grid-two-cols">
          <div className="nobita-container">
            ...
            <img src="/images/nobita.png" width="530" height="700" alt="nobita" />
            </div>
          </div>
          <div className="boyshostel">
            <p>BOYS HOSTEL</p>
            <img src="/images/boyshostel.png" width="730" height="520" alt="nobita" />
          </div>
        </div>
        <div className="container grid grid-two-cols">
          <div className="admissionpharmacy-container">
            <div className="girlshostel">
            <p>GIRLS HOSTEL</p>
            <img src="/images/girlshostel.png" width="790" height="550"/>
          </div>
          </div>
          <div className="shizukaimage">
          <div className="shizuka">
            <img src="/images/shizuka.png" width="430" height="620" alt="nobita" />
            </div>
      ...
      {/* Email Form */}
      <div className="hero-container">
          <p className="hostel-line" style={{ color: "green" }}>
            for the true hostelers
          </p>
          <h1>Experience a vibrant community</h1>
        </div>
        ...
        <div class="footer-container">
            <div class="row">
                ...
                <div class="mail-section">
                  <a href="mailto:info@sviet.ac.in" class="footer-section-mail-id">info@sviet.ac.in</a>
