    ...
    <>
      ...
      <div className="whatsapp">
        ...
        <div className="WhatsAppname">
          <img src="/images/whatsapp.png" width="55" height="50" alt="WhatsApp" />
        </div>
        <br />
        <h2> Join the D Block Students WhatsApp Group! 📲✨ Stay connected, informed, and engaged!</h2>
        <div className="qr">
